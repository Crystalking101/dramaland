...
export default function HeroBanner({ shows }: { shows: any[] }) {
  ...
  return (
    <>
      <style>{`
        .hero-outer { padding: 30px 45px 20px 45px; }
        .hero-inner { height: 490px; }
        @media (max-width: 640px) {
          .hero-outer { padding: 16px 16px 16px 16px; }
          .hero-inner { height: 360px; }
        }
      `}</style>

      <div className="hero-outer">
        <div className="hero-inner" style={{position: 'relative', width: '100%', overflow: 'hidden', borderRadius: '16px'}}>
